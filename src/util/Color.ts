...
export class Color {
   ...
   * @param defaults
   */
  public static createFormatters<T>(
    map: Map<T, Color | ColorFormatter>,
    defaults?: Map<T, Color | ColorFormatter>
  ): Map<T, ColorFormatter> {
   ...
   * @param from
   */
  private static mergeMaps<T>(
    to: Map<T, ColorFormatter>,
    from: Map<T, Color | ColorFormatter>
  ) {
